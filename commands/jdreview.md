...
- Let them. They're an adult. But record the gap in `.jdvance/knowledge.json` with a note.
...
- This is the richest source of mastery signals. Record everything to `.jdvance/knowledge.json`:
